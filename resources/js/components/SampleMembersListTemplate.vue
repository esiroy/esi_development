    ...
    <div class="table-responsive">
        ...
        <tbody>
            <tr>
                ...
                <td class="small text-center"><img src="/images/iClass.jpg"></td>
                <td class="small">該当なし</td>
                <td class="small text-center"><img src="/images/iHistory.jpg"></td>
                <td class="small text-center"><img src="/images/iReportCard.jpg"></td>
                <td class="small text-center"><img src="/images/iMonthlyRC.jpg"></td>
