                ...
                <div id="member-exam-records" class="section">
                    ...
                    <div class="row pt-2">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="row">
                                        <div class="col-2 pr-0">
                                            ...
                                            <select name="year" v-model="user.examRecord.toeic.year" class="form-control form-control-sm">
                                                <option value="">-- Select --</option>
                                                <option v-for="year in years" :value="year" :key="year">{{ year }}</option>
                                            </select>
                                        </div>
                                        <div class="col-2 pr-0">
                                            ...
                                            <select id="toeicMonth" name="month" v-model="user.examRecord.toeic.month" class="form-control form-control-sm">
                                                <option value="">-- Select --</option>
                                                <option value="JAN" class="mx-0 px-0">January</option>
                                                <option value="FEB">Febuary</option>
                                                <option value="MAR">March</option>
                                        ...
                                        <div class="col-2 pr-0">
                                            ...
                                            <input id="toeicGrade" type="text" name="toeicGrade" v-model="user.examRecord.toeic.grade" class="form-control  form-control-sm d-inline-block">
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="col-6 offset-md-2">
                            ...
                            <div class="row py-2 bg-lightgray border-bottom" v-for="toeic in user.toeicList" :key="toeic.id" >
                                <div class="col-3 col-md-3 text-center">
                                    {{ toeic.year }}
                                </div>
                    ...
                    <div class="row pt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="row">
                                        <div class="col-2 pr-0">
                                            <div class="text-center">Year</div>
                                            <select name="year" v-model="user.examRecord.eiken.year" class="form-control form-control-sm">
                                                <option value="">-- Select --</option>
                                                <option v-for="year in years" :value="year" :key="year">{{ year }}</option>
                                            </select>
                                        </div>
                                        <div class="col-2 pr-0">
                                            <div class="text-center">Month</div>
                                            <select id="eikenMonth" name="month" v-model="user.examRecord.eiken.month" class="form-control form-control-sm">
                                                <option value="">-- Select --</option>
                                                <option value="JAN" class="mx-0 px-0">January</option>
                                                <option value="FEB">Febuary</option>
                                                <option value="MAR">March</option>
                                        ...
                                        <div class="col-2 pr-0">
                                            ...
                                            <!--input id="eikenGrade" type="text" name="eikenGrade" v-model="user.examRecord.eiken.grade" class="form-control  form-control-sm d-inline-block">-->

                                            <select id="eikenGrade" name="eikenGrade" v-model="user.examRecord.eiken.grade"  class="form-control  form-control-sm d-inline-block">
                                                <option value="EIKEN_5">5</option>
                                                <option value="EIKEN_4">4</option>
                                                <option value="EIKEN_3">3</option>
                                                <option value="EIKEN_PRE2">Pre 2</option>
                                                <option value="EIKEN_2">2</option>
                                                <option value="EIKEN_PRE1">Pre 1</option>
                                                <option value="EIKEN_1">1</option>
                                            </select>

                                        </div>
                                        <div class="col-6">
                                            <button class="btn btn-success btn-sm d-inline-block mt-4"  @click.prevent="addEIKEN()">Add</button>
                                        </div>
                                    </div>
                        ...
                        <div class="col-6 offset-md-2">
                            <!--[start] enumaration of all TOEIC timeslot */-->
                            <div class="row py-2 bg-lightgray border-bottom" v-for="eiken in user.eikenList" :key="eiken.id" >
                                <div class="col-3 col-md-3 text-center">
                                    {{ eiken.year }}
                                </div>
                                <div class="col-3 col-md-3 text-center">                                            
                                ...
                                <div class="col-3 col-md-3 text-center">     
                                    <input type="text" :value="eiken.grade" class="form-control form-control-sm d-inline-block" />
                                </div> 
                            </div> 
                        </div>
