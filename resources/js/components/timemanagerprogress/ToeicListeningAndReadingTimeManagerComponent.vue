<template>
  <div id="timeManager-TOEIC_Listening_and_Reading" class="d-none">
    <div class="message"></div>

    <form
      name="form-timemanager-TOEIC_Listening_and_Reading"
      id="form-timemanager-TOEIC_Listening_and_Reading"
    >
      <div class="row">
      ...
      <div class="row pt-2">
        <div :class="this.size.leftColumn">
          <div class="pl-2 small">
            <span class="text-danger">*</span> Total Minutes
          </div>
        </div>
        <div :class="this.size.rightColumn">
          <input
            ...
            id="total"
            disabled
            name="TOEIC_Listening_and_Readingtotal"
            v-model="data.total"
            :class="this.size.select + ' form-control form-control-sm '"
          />
        </div>
...
export default {
  name: "TOEIC_Listening_and_ReadingTimeManager",
  data() {
    return {
      ja: ja,
      en: en,
