<template>
    ...
    <div class="main-component-holder" v-if="this.$props.is_lesson_completed == false">
    ...
    <div class="main-component-holder" v-else>
        Lesson has been completed

        {{ this.$props.lesson_completed }}
...
export default {
    ...
    mounted() {
        ...
        if (this.$props.is_lesson_completed) {
            alert (this.$props.is_lesson_completed)
        } else {
            alert ("not complete!")
        }
