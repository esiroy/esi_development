            ...
            <div class="tool-container">
                ...
                <div class="tool-wrapper">
                 ...
                 <div class="tool-wrapper mt-2">
                    <div class="brushes" v-show="isBrush">
                        <button type="button" value="5" :class="['brush', (stroke == 10) ? 'active' : '']"  @click="setBrushStroke(1, 10)"></button>
                        <button type="button" value="6" :class="['brush', (stroke == 20) ? 'active' : '']"  @click="setBrushStroke(1, 20)"></button>
                        <button type="button" value="7" :class="['brush', (stroke == 30) ? 'active' : '']"  @click="setBrushStroke(1, 30)"></button>
                    </div> 
                </div>         
...
export default {
    ...
    mounted() {
        ...
        this.canvas[1] = new fabric.Canvas(ref1);
        this.canvas[2] = new fabric.Canvas(ref2);

        this.selectorTrace(fabric);
