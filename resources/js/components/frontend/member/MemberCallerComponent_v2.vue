                                                            ...
                                                            <b-card no-body>
                                                                <b-card-header header-tag="header" class="p-0" role="tab">
                                                                    ...
                                                                    <b-button-group  block class="w-100">
                                                                        ...
                                                                        <!--<b-button block v-b-toggle="'accordion-'+row.item.id" variant="primary" @click.prevent="getLessonImages(row.index, row.item.id)">-->

                                                                        <b-button block variant="primary" @click.prevent="getLessonImages(row.index, row.item.id)">
                                                                            <div class="small float-left">
                                                                               {{ row.index }} {{ row.item.folder_name }} 
                                                                            </div>                                                           
                                                                        </b-button>                                                     
                                                                ...
                                                                <b-collapse :id="'accordion-'+row.item.id"  accordion="my-accordion" role="tabpanel">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            closeAllAccordions() {
                this.$refs['lesson-table'].$el.querySelectorAll('.collapse').forEach((el) => {                                       
                    el.classList.remove('show');                    
                });             
            },                        
            getLessonImages(index, folderID) {
    
               this.$root.$emit('bv::toggle::collapse', 'accordion-'+folderID)
