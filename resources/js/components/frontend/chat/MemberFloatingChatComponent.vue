<template>
    ...
    <div class="container">
        ...
        <div class="fixed-bottom mb-2 mr-5 pb-2">

            <b-button v-b-modal.popMemberChat  class="chat-button float-right"  variant="primary">
                 <h2 class="fa fa-comments mt-1"></h2>
                 <span class="badge badge-danger text-white small m-0 p-1" v-show="this.unread_message_count > 0">{{this.unread_message_count}}</span>
            </b-button>
        </div>
       

        <b-modal id="popMemberChat" size="lg" title="Customer support" header-bg-variant=""  header-class="" hide-footer>
             <div id="MemberChat">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-3 px-1">
                                ...
                                <div id="attach-button" class="input-group-append d-inline-block float-left">
                                    <label id="file-select-button" for="file" class="btn btn-lg btn-primary mr-1">
