<template>
  ...
  <div id="ScoresComponent" class="ScoresComponent">       
    ...
    <!--[start] IELTS -->
    <div id="examination-score-TOEFL_ITP_Level_1" class="section examScoreHolder">
        ...
        <div class="row pt-2">
            ...
            <div :class="this.size.rightColumn">
                <select @change="getTotal" id="listening" name="listening" v-model="examScore.TOEFL_ITP_Level_1.listening" 
        ...
        <div class="row">
            ...
            <div :class="this.size.rightColumn">
                <select @change="getTotal" id="structure_and_written_expression" name="structure_and_written_expression" 
                    v-model="examScore.TOEFL_ITP_Level_1.structure_and_written_expression" 
                    :class="this.size.select +' form-control form-control-sm pl-0'">
        ...
        <div class="row pt-2">
            ...
            <div :class="this.size.rightColumn">
                <select @change="getTotal" id="reading" name="reading" v-model="examScore.TOEFL_ITP_Level_1.reading" :class="this.size.select +' form-control form-control-sm pl-0'">
        ...
        <div class="row pt-2">
            ...
            <div :class="this.size.rightColumn">
                <input type="text" id="total" disabled name="total" v-model="examScore.TOEFL_ITP_Level_1.total" 
...
export default {
  name: "ToeflITPLevel1ScoreComponent",
  ...
  methods: {
    ...
    {  
        ...
        let listening = this.examScore.TOEFL_ITP_Level_1.listening;
        let structure_and_written_expression = this.examScore.TOEFL_ITP_Level_1.structure_and_written_expression;      
        let reading = this.examScore.TOEFL_ITP_Level_1.reading;       
