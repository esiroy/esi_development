...
<head>
    ...
    <link rel="preload" href="{{ asset('css/app.css') .'?id=2024_8_19' }}" as="style">

    <link rel="stylesheet" href="{{ asset('css/app.css')  .'?id=2024_8_19' }}">

    <script src="{{ asset('js/admin.js') .'?id=2024_8_19'  }}" defer></script>
