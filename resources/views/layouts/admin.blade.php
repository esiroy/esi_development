...
<head>
    ...
    <link rel="preload" href="{{ asset('css/app.css') .'?id=2024_8_20' }}" as="style">

    <link rel="stylesheet" href="{{ asset('css/app.css')  .'?id=2024_8_20' }}">

    <script src="{{ asset('js/admin.js') .'?id=2024_8_20'  }}" defer></script>
