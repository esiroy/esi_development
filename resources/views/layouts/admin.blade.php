...
<head>
    ...
    <link rel="preload" href="{{ asset('css/app.css') .'?id=version_5_7_1' }}" as="style">

    <link rel="stylesheet" href="{{ asset('css/app.css')  .'?id=version_5_7_1' }}">
    <script src="{{ asset('js/admin.js') .'?id=version_5_7_1'  }}" defer></script>
