...
<head>
   ...
   <!-- Styles -->
    <link rel="preload" href="{{ asset('css/app.css') .'?id=version_5_5'  }}" as="style">
    <link rel="stylesheet" href="{{ asset('css/app.css') .'?id=version_5_5'  }}">
    
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') .'?id=version_5_5'  }}" defer ></script>
