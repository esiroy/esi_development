...
<head>
   ...
   <!-- Styles -->
    <link rel="preload" href="{{ asset('css/app.css') .'?id=version_5_8'  }}" as="style">
    <link rel="stylesheet" href="{{ asset('css/app.css') .'?id=version_5_8'  }}">
    
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') .'?id=version_5_8'  }}" defer ></script>
