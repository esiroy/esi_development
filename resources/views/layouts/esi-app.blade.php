...
<head>
   ...
   <!-- Styles -->
    <link rel="preload" href="{{ asset('css/app.css') .'?id=version_5_7'  }}" as="style">
    <link rel="stylesheet" href="{{ asset('css/app.css') .'?id=version_5_7'  }}">
    
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') .'?id=version_5_7'  }}" defer ></script>
