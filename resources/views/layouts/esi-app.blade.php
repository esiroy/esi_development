...
<head>
   ...
   <!-- Styles -->
    <link rel="preload" href="{{ asset('css/app.css') .'?id=version_6_0'  }}" as="style">
    <link rel="stylesheet" href="{{ asset('css/app.css') .'?id=version_6_0'  }}">
    
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') .'?id=version_6_0'  }}" defer ></script>
