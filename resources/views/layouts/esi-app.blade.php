...
<head>
   ...
   <!-- Styles -->
    <link rel="preload" href="{{ asset('css/app.css') .'?id=version_4_30'  }}" as="style">
    <link rel="stylesheet" href="{{ asset('css/app.css') .'?id=version_4_30'  }}">
    
    <!-- Scripts -->
    <script src="{{ asset('js/app.js') .'?id=version_4_30'  }}" defer ></script>
