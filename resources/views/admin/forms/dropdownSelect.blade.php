<div id="field_{{ $id }}" class="card esi-card-writing mb-2 field_container">
    <div class="card-header esi-card-header-writing">
        ...
        <div class="float-right">
            <a id="{{ $id }}_showFieldOptions" href="#" class="text-secondary btnShowFieldOptions"><i
                    class="fa fa-caret-down fa-lg"></i></a>
            <a id="{{ $id }}_hideFieldOptions" href="#" class="text-secondary btnHideFieldOptions d-none"><i
    ...
    <div class="card-body">
        ...
        <div class="card-text">
            ...
            <!--FIELD TYPE-->
            <input type="hidden" id="{{ $id }}_fieldType" name="{{ $id }}_fieldType"
                        ...
                        <div class="fields">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" id="label" name="{{ $id }}_label"
                                        value="{{ $label ?? '' }}" required class="form-control pt-0">
                                </div>
                            </div>
                            ...
                            @if (isset($display_meta['required']))
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <br />
                                        <input id="required" name="{{ $id }}_required" type="checkbox"
                                            @if ($display_meta['required'] == 'true') {{ "checked='checked" }} @endif> <label class="form-label">Required</label>
                                    </div>
                                </div>
                            @endif
                    ...
                    <div id="tabs-advanced">
                        <div class="row">
                            <div class="col">
                                ...
                                <br />
                                <input type="text" id="default_value" name="{{ $id }}_default_value"
                                    value="{{ $display_meta['default_value'] ?? '' }}" class="form-control col-md-6">
                            </div>
                        </div>
                    </div>
                </div>
