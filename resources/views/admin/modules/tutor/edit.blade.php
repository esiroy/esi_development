                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="japanese_fluency" class="form-control form-control-sm @error('japanese_fluency') is-invalid @enderror" required>
                                ...
                                <option value="LITTLE" @if(old('japanese_fluency')=='LITTLE' || $tutor->fluency === "LITTLE") {{"selected"}} @endif>少し話せる (Little)</option>
...
<script>
	...
	// allow these tags to accept classes
       ...
       allowedContent: 'html5audio; object(*); object param embed a p b i; audio[src, autoplay, controls, controlslist]; a[!href]; object[data]; object[width]; object[height]; param[name]; param[value]; iframe[*]; iframe[width]; iframe[height], audio',       
       toolbarGroups: [
