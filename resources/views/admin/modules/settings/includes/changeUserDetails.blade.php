    ...
    <div class="form">
        ...
        <div id="member-password-row" class="row pt-2">
            <div class="col-12">
                ...
                <form method="POST" action="{{ route('admin.settings.update', $user->id) }}">
                    @csrf
                    @method('put')
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input type="text" id="japanese_firstname" name="japanese_firstname" class="form-control form-control-sm @error('japanese_firstname') is-invalid @enderror"
                                value="{{ old('japanese_firstname', isset($user->japanese_firstname ) ? $user->japanese_firstname : '') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input type="text" id="japanese_lastname" name="japanese_lastname" class="form-control form-control-sm @error('japanese_lastname') is-invalid @enderror"
                                value="{{ old('japanese_lastname', isset($user->japanese_lastname ) ? $user->japanese_lastname : '') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <select name="itemsPerPage" class="form-control form-control-sm col-md-2 @error('itemsPerPage') is-invalid @enderror">
	  							<option value="5" @if ($user->items_per_page == 5) {{ "selected" }} @endif >5</option>
	  							<option value="10" @if ($user->items_per_page == 10) {{ "selected" }} @endif>10</option>					  							
