                            ...
                            <div class="col-12">
                                <div class="card esi-card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="writing-form" novalidate method="POST" enctype="multipart/form-data" action="{{ route('writingSaveEntry.store', ['form_id' => $form_id  ]) }}" class="form-horizontal" style="display:none">
                                            @csrf
                                            @method('POST')
