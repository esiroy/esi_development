        ...
        <div class="row ml-4 target_score">
            ...
            <div class="col-md-8">
                <select id="EIKEN_grade_3_1st_stage" name="EIKEN_Grade_3_1st_Stage"  class="form-control form-control-sm pl-0">
                    ...
                    <option value="{{ $score }}" class="mx-0 px-0" @if( isset($target_score['EIKEN_Grade_3']) && $target_score['EIKEN_Grade_3'] == $score) {{ ' selected ' }} @endif>{{ $score }}</option>
                    @endfor
                </select>
            </div>
        </div>
        ...
        <div class="row ml-4 target_score">
            ...
            <div class="col-md-8">
                <select id="EIKEN_grade_pre_2_1st_stage" name="EIKEN_Grade_Pre_2_1st_Stage" class="form-control form-control-sm pl-0">
                    ...
                    <option value="{{ $score }}" class="mx-0 px-0" @if( isset($target_score['EIKEN_Grade_pre_2']) && $target_score['EIKEN_Grade_pre_2'] == $score) {{ ' selected ' }} @endif>{{ $score }}</option>
                    @endfor
                </select>            
            </div>
        </div>
        ...
        <div class="row ml-4 target_score">
            ...
            <div class="col-md-8">
                <select id="EIKEN_grade_2_1st_stage" name="EIKEN_Grade_2_1st_Stage"  class="form-control form-control-sm pl-0">
                    ...
                    <option value="{{ $score }}" class="mx-0 px-0" @if( isset($target_score['EIKEN_Grade_2']) && $target_score['EIKEN_Grade_2'] == $score) {{ ' selected ' }} @endif>{{ $score }}</option>
                    @endfor
                </select>            
            </div>
        </div>
        ...
        <div class="row ml-4 target_score">
            ...
            <div class="col-md-8">
                <select id="EIKEN_grade_pre_1_1st_stage" name="EIKEN_Grade_Pre_1_1st_Stage"  class="form-control form-control-sm pl-0">
                    ...
                    <option value="{{ $score }}" class="mx-0 px-0" @if( isset($target_score['EIKEN_Grade_pre_1']) && $target_score['EIKEN_Grade_pre_1'] == $score) {{ ' selected ' }} @endif>{{ $score }}</option>
                    @endfor
                </select>            
            </div>
        </div>
        ...
        <div class="row ml-4 target_score">
            ...
            <div class="col-md-8">
                <select id="EIKEN_grade_1_1st_stage" name="EIKEN_Grade_1_1st_Stage"  class="form-control form-control-sm pl-0">
                    ...
                    @for($score = 0; $score <= 2250; $score++)                    
                    <option value="{{ $score }}" class="mx-0 px-0" @if( isset($target_score['EIKEN_Grade_1']) && $target_score['EIKEN_Grade_1'] == $score) {{ ' selected ' }} @endif>{{ $score }}</option>
                    @endfor
                </select>            
            </div>
        </div>
