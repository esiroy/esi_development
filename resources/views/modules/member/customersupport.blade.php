            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div id="member-lesson-schedules" class="card esi-card">
                        ...
                        <div class="card-body">
                            <p>お問い合わせの前に, お問い合わせの前に <a href="{{ url('faq') }}" style="color:red">よくあるご質問</a>のページをご確認ください。</p>
                            ...
                            <div class="mt-3">
                                ...
                                <p>マイページ左側「管理人」の中にある「スカイプ(ZOOM)のアイコン」をクリックするとセブマネジャーへつながりますマイページ左側「管理人」の中にある「スカイプ<span style="color:red;">(ZOOM)</span>のアイコン」をクリックするとセブマネジャーへつながります</p>
                            </div>
