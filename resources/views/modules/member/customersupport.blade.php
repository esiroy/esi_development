                    ...
                    <div id="member-lesson-schedules" class="card esi-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                ...
                                <p>講師からコールがなかったり、レッスン中のトラブルなど、緊急な対応については、「講師への連絡」からチャットをご利用ください。チャットが繋がらない場合はセブマネジャー
                                <a href="JavaScript:PopupCenter('https://www.mytutor-jpn.com/info/2021/0717162035.html','スカイプ又はZOOM',900,720);">（スカイプ又はZOOM）</a>までご連絡ください。</p>
