...
<head>
    ...
    <link rel="shortcut icon" href="http://localhost:9001/demos/logo.png">
    <link rel="stylesheet" type="text/css" href="http://localhost:9001/demos/css/emojionearea.min.css">

    <script src="http://localhost:9001/demos/js/jquery.min.js"></script>
    <link href="http://localhost:9001/demos/css/bootstrap.min.css" rel="stylesheet">
    <script src="http://localhost:9001/node_modules/webrtc-adapter/out/adapter.js"></script>
    <script src="http://localhost:9001/dist/RTCMultiConnection.min.js"></script>
    <script src="http://localhost:9001/socket.io/socket.io.js"></script>
    <script src="http://localhost:9001/node_modules/fbr/FileBufferReader.js"></script>

    <script src="http://localhost:9001/node_modules/canvas-designer/dev/webrtc-handler.js"></script>
    <script src="http://localhost:9001/node_modules/canvas-designer/canvas-designer-widget.js"></script>
    <script src="http://localhost:9001/demos/js/emojionearea.min.js"></script>
    <!-- <script src="http://localhost:9001/node_modules/multistreamsmixer/MultiStreamsMixer.js"></script> -->
...
<body>
    ...
    <script>
        ...
        designer.widgetHtmlURL = 'http://localhost:9001/node_modules/canvas-designer/widget.html';
        designer.widgetJsURL = 'http://localhost:9001/node_modules/canvas-designer/widget.min.js'
