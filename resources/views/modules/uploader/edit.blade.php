...
<div class="container">
    <div class="row">
                ...
                <div class="card-header">
                    ...
                    <div class="dropdown" style="display:inline-block;">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item small" href="{{ URL::route('uploader.show', $folder->folder_name) }}">Upload Files</a>
                    ...
                    <div id="folders" >
                        @foreach ($folders as $folder_item)
                            <div class="mx-2">
                                ...
                                <a href="{{ URL::to('/uploader/'. $folder->folder_name ) }}">{{ $folder_item->folder_name }}</a>
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="col-md-9">
            ...
            <div class="card">
                <div class="card-header">Update Folder</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('uploader.update', $folder->folder_name) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="folder_name" type="text" 
                                    ...
                                    name="folder_name" value="{{ (old('folder_name')) ? old('folder_name') : $folder->folder_name }}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="folder_name" type="text" 
                                    ...
                                    autocomplete="folder_description" 
                                    autofocus 
                                    cols="20" 
